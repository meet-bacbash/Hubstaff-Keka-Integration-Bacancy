"""
email_file_fetch_cod will fetch the latest file containing the hubstaff logs of employees from COD hubstaff
...
MAIL_USER = "logs.kekacod@bacancy.com"
MAIL_PASS = "bqbwedrrnkjdjrjg"
SUBJECT_TO_FIND = "Bacancy Services Pvt. Ltd. Work Sessions Report for yesterday"

def download_attachments_cod():
    """
                    ...
                    for part in msg.walk():
                        ...
                        if part.get_content_disposition() == "attachment":
                            ...
                            if filename:
                                ...
                                filepath = os.path.join("cod_downloads", filename)
